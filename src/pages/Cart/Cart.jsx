...
function Cart() {
  ...
  useEffect(()=>{
    ...
    cartItems.forEach(cartItem => {
      temp = temp + Number.parseInt(cartItem.price);
    });
    setTotalAmount(temp);
  },[cartItems])
...
// };
  ...
  return (
    <Layout >
      <div className="mb-[60%] h-screen bg-gray-100 pt-5 " style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }}>
